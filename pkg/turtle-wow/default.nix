...
pkgs.stdenv.mkDerivation rec {
  ...
  installPhase = ''
      ...
      cp ${pkgs.copyPathToStore ./res/icon.png} $out/share/icons/hicolor/256x256/apps/turtle-wow.png
      ...
      pkgs.lib.concatStrings (
        pkgs.lib.mapAttrsToList (
          ...
          ''
            ...
            cp ${generateAccountConfig accountName accountConfig} $out/share/turtle-wow/WTF/Account/${upperAccountName}/SavedVariables.lua    
    ...
    ${
      pkgs.lib.concatStrings (
        pkgs.lib.mapAttrsToList (
          ...
          ''
            mkdir -p $out/share/turtle-wow/WTF/Account/${upperAccountName}    
            cp ${generateBindingsFile accountName bindingConfig} $out/share/turtle-wow/WTF/Account/${upperAccountName}/bindings-cache.wtf    
          ...
          ${
            pkgs.lib.concatStringsSep "\n" (
              pkgs.lib.mapAttrsToList (
                ...
                pkgs.lib.concatStringsSep "\n" (
                  pkgs.lib.mapAttrsToList (characterName: characterMacros: ''
